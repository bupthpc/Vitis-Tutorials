...
proc create_root_design { parentCell } {
  ...
  # Create instance: dlbf_data_0, and set properties
  set dlbf_data_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:dlbf_data:1.0 dlbf_data_0 ]
  ...
  connect_bd_intf_net -intf_net axi4stream_vip_0_S_AXIS [get_bd_intf_pins axi4stream_vip_0/S_AXIS] [get_bd_intf_pins dlbf_data_0/M00_AXIS]
  connect_bd_intf_net -intf_net axi4stream_vip_1_S_AXIS [get_bd_intf_pins axi4stream_vip_1/S_AXIS] [get_bd_intf_pins dlbf_data_0/M01_AXIS]
  connect_bd_intf_net -intf_net axi4stream_vip_2_S_AXIS [get_bd_intf_pins axi4stream_vip_2/S_AXIS] [get_bd_intf_pins dlbf_data_0/M02_AXIS]
  connect_bd_intf_net -intf_net axi4stream_vip_3_S_AXIS [get_bd_intf_pins axi4stream_vip_3/S_AXIS] [get_bd_intf_pins dlbf_data_0/M03_AXIS]
  connect_bd_intf_net -intf_net axi_vip_0_M_AXI [get_bd_intf_pins axi_vip_0/M_AXI] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins dlbf_data_0/S_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports m_axis_clk] [get_bd_pins axi4stream_vip_0/aclk] [get_bd_pins axi4stream_vip_1/aclk] [get_bd_pins axi4stream_vip_2/aclk] [get_bd_pins axi4stream_vip_3/aclk] [get_bd_pins dlbf_data_0/m_axis_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axi_vip_0/aresetn] [get_bd_pins dlbf_data_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net -net resetn_400MHz_1 [get_bd_ports resetn_400MHz] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net s_axi_aclk_1 [get_bd_ports s_axi_aclk] [get_bd_pins axi_vip_0/aclk] [get_bd_pins dlbf_data_0/s_axi_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00400000 -target_address_space [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs dlbf_data_0/S_AXI/reg0] -force
