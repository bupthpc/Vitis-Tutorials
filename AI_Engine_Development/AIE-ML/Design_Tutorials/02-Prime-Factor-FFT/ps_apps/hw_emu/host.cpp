...
static constexpr int32_t        LOOP_CNT_O = 6; // Try to stop it early
...
int main(int argc, char* argv[])
{
  ...
  auto dma_src = xrt::kernel(my_device, xclbin_uuid, "pfa1008_dma_src_wrapper:{dma_src}");
  std::cout << STR_PASSED << "auto dma_src = xrt::kernel(my_device, xclbin_uuid, \"pfa1008_dma_src_wrapper:{dma_src}\")" << std::endl;
